...
SECRET_KEY = 'django-insecure-visw4i7gm_eictzmp+m8o(l78gpko0l#i$k=0084r)-3-95t+x'
...
MIDDLEWARE = [
    ...
    'uzCloud.middleware.PageViewMiddleware',
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": os.path.join(BASE_DIR, 'static/img/test.jpg'),
